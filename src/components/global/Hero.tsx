      ...
      >
        <div className="flex h-full w-full flex-col items-center justify-center gap-6">
          ...
          >
            ...
            <div className="text-lg mt-2 text-emerald-200">
          ...
          <div className="flex w-full justify-center gap-4">
            ...
            <Link href="/campaigns">
              <Button
                variant="outline"
                className="flex h-12 cursor-pointer items-center gap-2 rounded-full border-2 border-white bg-transparent px-6 text-white shadow-md hover:bg-white hover:text-emerald-900"
                size={"lg"}
              >
                Browse Campaigns
              </Button>
